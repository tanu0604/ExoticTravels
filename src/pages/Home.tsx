        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-xl max-w-4xl mx-auto leading-relaxed">
              ...
              travel experts will create a personalized itinerary just for you
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
                ...
                {submitStatus === "success" && (
                  <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-6 text-center card-hover">
                    ...
                    <p className="text-green-700">
                      Your travel inquiry has been submitted successfully. Our
                      travel experts will contact you within 24 hours with a
                  ...
                  <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-6 text-center card-hover">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      <a
                        ...
                        className="text-red-600 hover:text-red-800 font-medium hover:scale-105 transition-transform duration-300"
                      >
                        📞 Call: +91 98765 43210
                      </a>
                      <a
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              ...
              >
                ...
                <p className="text-gray-600 text-sm mb-3">
                  Meet us in person for detailed planning
                </p>
